                ...
                <tbody>
                    ...
                    foreach ($mhs as $mahasiswa) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_mhs.php?nim_mahasiswa=<?php echo $mahasiswa['nim_mahasiswa']; ?>" type="button" class="btn btn-warning btn-sm">EDIT</a>
                                <a href="hapus.php?nim_mahasiswa=<?php echo $mahasiswa['nim_mahasiswa']; ?>" type="button" class="btn btn-danger btn-sm" onclick="return confirm ('yakin')">HAPUS</a>
                            </td>
                        </tr>
                    <?php
                        $no++;
